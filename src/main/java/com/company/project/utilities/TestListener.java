...
public class TestListener extends TestListenerAdapter {
	...
	public void onTestFailure(ITestResult result) {
		...
		if (driver != null) {
			String imagePath = System.getProperty("user.dir")+"/Screenshots"+"/"+testClassName+"/"+takeScreenShot(driver, screenShotName, testClassName);
	...
	public static String takeScreenShot(WebDriver driver,
		...
		try {
			...
			driver = (RemoteWebDriver) new Augmenter().augment(driver);   // remote web driver screenshot configuration.
