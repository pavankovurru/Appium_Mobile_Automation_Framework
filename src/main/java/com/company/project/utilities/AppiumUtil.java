...
public class AppiumUtil {
  ...
  public Set<String> switchToWebView() {
  ...
  public MobileElement scrollAndroid(String resourceID, String text) {
  ...
  public MobileElement scrollAndroidUsingindex(String resourceID, int index) {
  ...
  public MobileElement androidScrollToText(String text) {
  ...
  public MobileElement androidScrollToContentDesc(String contentDesc) {
  ...
  public MobileElement androidScrollToID(String id) {
  ...
  public void press_Hold_Moveto_NewElement(WebElement element1, WebElement element2) {
    TouchAction touch = new TouchAction(driver);
  ...
  public boolean isElementPresentUsingAccessibilityId(String id) {
  ...
  public void horizontalSwipe(String mainContainerElement, String classNameOFSubElements) {
